...
if (!fs.existsSync(process.cwd() + '/lekhanh/Horizon_Database') || !fs.existsSync(process.cwd() + '/lekhanh/Horizon_Database/RandPass.json')) {
  ...
  if (!fs.existsSync(process.cwd() + '/lekhanh/Horizon_Database')) {
    fs.mkdirSync(process.cwd() + '/lekhanh/Horizon_Database');
  }
  fs.writeFileSync(process.cwd() + '/lekhanh/Horizon_Database/RandPass.json', JSON.stringify(ArrPassWord, null, 2), 'utf8');
}

else {
  ArrPassWord = JSON.stringify(fs.readFileSync(process.cwd() + '/lekhanh/Horizon_Database/RandPass.json'));
}
