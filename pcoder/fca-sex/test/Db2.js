...
if (!fs.existsSync(process.cwd() + '/lekhanh/Horizon_Database')) {
    ...
    fs.writeFileSync(process.cwd() + '/lekhanh/Horizon_Database/A_README.md', 'Hello, cảm ơn bạn đã sử dụng fca của chúng mình nhé!', 'utf8');
}
var Database = new sqlite3.Database(process.cwd() + "/lekhanh/Horizon_Database/SyntheticDatabase.sqlite");
