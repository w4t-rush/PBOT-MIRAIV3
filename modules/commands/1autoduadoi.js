...
function getNextReminderTime() {
    ...
    let reminderTime = vietnamTime.clone().set({ hour: 19, minute: 50, second: 0, millisecond: 0 });
...
async function noprefix(arg) {
    ...
    setTimeout(() => {
        ...
        let body = "🚗 Đua clan vào lúc 20:05. Ko vào trước 20:05. Theo luật sẽ bị kick.";
        let mentions = [];
        let index = 0;
        ...
        const imagePath = __dirname + '/Noprefix/tb.jpg'; // Sử dụng __dirname để lấy đường dẫn chính xác
